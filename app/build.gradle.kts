...
android {
    namespace = "com.example.descubremastalpaproyect"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.descubremastalpaproyect"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.compose.ui:ui-android:1.5.3")//LocalContext
